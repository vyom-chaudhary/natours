...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidnlvbWNoYXVkaGFyeSIsImEiOiJja2EyODFxNjgwN3JsM2ZwMHBoeXB6anUxIn0.A9q0k2S3kfQigUcagd9Yvw';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlerts)('success', 'login succesfully!');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlerts)('error', 'error in Logged out !');
...
var stripe = Stripe('pk_test_fEZ8OFzmeaw0jLs2S1THJqGl006qXItXPX');
